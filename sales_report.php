...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <div class="flex-1 p-10">
            <h1 class="text-3xl font-bold mb-5">Laporan Penjualan</h1>

            <div class="mb-5">
                <h2 class="text-xl font-semibold">Ringkasan Penjualan</h2>
                <p>Total Penjualan: Rp <?php echo number_format($total_sales, 2, ',', '.'); ?></p>
                <p>Jumlah Pesanan: <?php echo $total_orders; ?></p>
                <p>Rata-rata Penjualan per Pesanan: Rp <?php echo number_format($total_orders > 0 ? $total_sales / $total_orders : 0, 2, ',', '.'); ?></p>
            </div>
                ...
                <tbody>
                    ...
                    foreach ($sales as $sale): ?>
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b"><?php echo $sale['customer_name']; ?></td>
                            <td class="py-2 px-4 border-b">Rp <?php echo number_format($sale['total_price'], 2, ',', '.'); ?></td>
                            <td class="py-2 px-4 border-b"><?php echo $sale['payment_status']; ?></td>
                            <td class="py-2 px-4 border-b"><?php echo $sale['created_at']; ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
